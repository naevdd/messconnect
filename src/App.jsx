...
function App() {
  ...
  return (
    ...
    <div id="1" className='flex gap-36 items-center justify-center'>
      <div className='h-14 w-6/12 mb-32 flex items-center bg-yellow-100 justify-center hover:bg-yellow-400 transition duration-500 hover:scale-110 w-14 border-4 p-60 bg-white border-black rounded-3xl'>
        <p className='font-bold text-5xl text-black'>HOST A MESS SERVICE?</p>
      </div>
      <div className='h-14 w-6/12 mb-32 flex items-center justify-center bg-yellow-100 hover:bg-yellow-400 transition duration-500 hover:scale-110 w-14 border-4 p-60 bg-white border-black rounded-3xl'>
